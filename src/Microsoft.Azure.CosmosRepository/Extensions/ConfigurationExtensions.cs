...
{
    /// <summary>
    /// Some useful extensions to pull values that will ve populated
    /// into <see cref="RepositoryOptions"/> from configuration
    /// </summary>
    public static class ConfigurationExtensions
    {
        ...
        /// instance to read teh config from.</param>
        public static string? GetCosmosRepositoryConnectionString(
        ...
        /// <param name="configuration">The <see cref="IConfiguration"/>
        /// instance to read teh config from.</param>
        public static string? GetCosmosRepositoryDatabaseId(
            this IConfiguration configuration) =>
            configuration.GetValue<string>(
