...
{
    /// <summary>
    /// A factory abstraction for a component that can create <see cref="IRepository{TItem}" /> instances.
    /// </summary>
    public interface IRepositoryFactory
    {
        /// <summary>
        /// Gets an <see cref="IRepository{TItem}" /> instance for the given <typeparamref
        /// name="TItem" /> type.
        /// </summary>
